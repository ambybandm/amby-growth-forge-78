...
const Benefits = () => {
  ...
  return <section className="py-20 bg-white font-lexend">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs defaultValue="business-owner" className="w-full">
            ...
            {benefitSections.map(section => <TabsContent key={section.id} value={section.id}>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {section.benefits.map((benefit, benefitIndex) => <div key={benefitIndex} className="text-left">
