              ...
              <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 relative z-10">
                <div className="flex-shrink-0">
                  <div className="relative">
                    <img 
                      ...
                      className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-gray-300 shadow-lg"
                    />
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <div 
                      className="bg-black text-white px-6 py-3 rounded-full cursor-pointer hover:bg-gray-800 transition-all duration-300 flex items-center justify-center"
                    ...
                    <div 
                      className="bg-gray-800 text-white px-6 py-3 rounded-full cursor-pointer hover:bg-black transition-all duration-300 flex items-center justify-center"
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 text-center shadow-xl border border-gray-200 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <div className="mb-8">
                <Button 
                  size="lg" 
                  className="bg-black hover:bg-gray-800 text-white px-8 md:px-12 py-4 md:py-5 text-lg md:text-xl font-bold rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
