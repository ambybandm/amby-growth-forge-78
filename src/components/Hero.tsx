        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6 md:mb-8">
              <h2 className="font-bold mb-4 md:mb-6 leading-tight text-black text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center mb-8 md:mb-12 px-4">
              <Button 
                size="lg" 
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold w-full sm:w-auto"
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-black text-black hover:bg-blue-600 hover:text-white hover:border-blue-600 px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold bg-transparent w-full sm:w-auto"
